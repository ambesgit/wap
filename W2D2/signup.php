     ...
     <fieldset>
         <legend>New User Signup</legend>
            <form action="signup-submit.php" method="post">                
                ...
                <p><label class=""left><strong>Password</strong></label><input type="password" name="password"/></p>
            ...
            <p><label class="left"><strong>Favorite OS:</strong></label><select name="favoriteOS"><br/>
